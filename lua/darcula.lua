...
M.configure_highlights = function()
  ...
  hi(0, "Identifier", { fg = colors.white })
  ...
  hi(0, "@lsp.type.parameter", { fg = colors.white })
  hi(0, "@lsp.type.variable", { fg = colors.white })
  hi(0, "@lsp.type.variable.go", { fg = colors.white })
  ...
  hi(0, "@variable.go", { fg = colors.white })
  ...
  hi(0, "CmpItemKindVariable", { fg = colors.white })
